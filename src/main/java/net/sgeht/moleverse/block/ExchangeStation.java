 ...
 * to care. Feed goes into the input, and every mole that surfaces through the
 * mound underneath takes some and leaves whatever it happened to dig up in the
 * output.</p>
 *
 ...
 *
 * <p>Not every worm is worth the same trip. The station grades what it is fed -
 * root nodules by the handful at one end, a glow worm at the other - and what
 * comes back changes in size and in kind with it. The tables and the reasoning
 * are in {@link ExchangeStationBlockEntity}.</p>
 */
public class ExchangeStation extends MoundAttachment implements EntityBlock {
    ...
    /**
     * A mole has come up through the mound. It takes the best feed it can pay
     * for and leaves a find.
     *
